...
class Config extends SB_Controller  {
	...
	public function postSave()
	{
			...
			$val .= 	"define('CNF_PPN_JUAL','".$this->input->post('cnf_ppn_jual',true)."');\n";
			$val .= 	"define('CNF_PPN_BELI','".$this->input->post('cnf_ppn_beli',true)."');\n";
			$val .= 	"define('CNF_NMKLINIK','".$this->input->post('cnf_nmklinik',true)."');\n";
			$val .= 	"define('CNF_ALAMAT','".$this->input->post('cnf_alamat',true)."');\n";
			$val .= 	"define('CNF_TLP','".$this->input->post('cnf_tlp',true)."');\n";
			$val .= 	"define('CNF_ABSENSI','".$this->input->post('cnf_absensi',true)."');\n";
			$val .= 	"?>";
