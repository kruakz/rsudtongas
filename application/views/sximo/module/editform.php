<script src="<?php echo base_url();?>sximo/js/simpleclone.js"></script>
...
$(document).ready(function(){
	...
	$("#lookup_table").jCombo("<?php echo site_url('sximo/module/combotable') ;?>" , {
		selected_value : "<?php echo $f['option']['lookup_table'];?>" ,
		initial_text : ' Select Table',
		
	});

	$("#lookup_key").jCombo("<?php echo site_url('sximo/module/combotablefield') ;?>?table=",
	...
	<?php $lv = explode("|", $f['option']['lookup_value']); ?>
		...
		$("#lookup_value1").jCombo("<?php echo site_url('sximo/module/combotablefield') ;?>?table=",
		{ selected_value : "<?php echo (isset($lv[0]) ? $lv[0] : '');?>", parent: "#lookup_table",   initial_text : ' Display Text'}); 
		
		$("#lookup_value2").jCombo("<?php echo site_url('sximo/module/combotablefield') ;?>?table=",
		{ selected_value : "<?php echo (isset($lv[1]) ? $lv[1] : '');?>", parent: "#lookup_table",   initial_text : ' Display Text'}); 
		
		$("#lookup_value3").jCombo("<?php echo site_url('sximo/module/combotablefield') ;?>?table=",
...
<form class="form-horizontal" action="<?php echo site_url('sximo/module/savefield/'.$module_name);?>" method="post">
...
<div class="" style="padding:30px;">			
  ...
  <div class="form-group standart-form file-upl"  style="display:none;">
	...
	<div class="col-md-8">
		<input name="path_to_upload" type="text" id="path_to_upload" class="form-control" value="<?php echo $f['option']['path_to_upload'];?>" placeholder="/uploads/yourfoldername/"/>
		<label class="radio"> 
