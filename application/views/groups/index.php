  ...
  <div class="page-content row">
	...
	<div class="page-content-wrapper m-t">
		<ul class="nav nav-tabs" style="margin-bottom:10px;">
			<li ><a href="<?php echo site_url('users');?>"><?php echo $this->lang->line('core.m_users'); ?> </a></li>
			<li class="active" ><a href="<?php echo site_url('groups');?>"><?php echo $this->lang->line('core.m_groups'); ?> </a></li>
		</ul>
		
    <div class="toolbar-line ">		
		<?php if($this->access['is_add'] ==1) : ?>
		<a href="<?php echo site_url('groups/add') ?>" class="tips btn btn-xs btn-info"  title="<?php echo $this->lang->line('core.btn_new'); ?>">
		...
		<a href="<?php echo site_url('groups/download') ?>" class="tips btn btn-xs btn-default" title="<?php echo $this->lang->line('core.btn_download'); ?>">
	...
	<?php echo $this->session->flashdata('message');?>
	 <form action='<?php echo site_url('groups/destroy') ?>' class='form-horizontal' id ='SximoTable' method="post" >
                ...
                <tr>
				 ...
				 <td>
					 <div class="btn-group">		
						...
						<li><a href="<?php echo site_url('groups/show/'.$row->group_id)?>"  class="tips "  title="view"><i class="fa  fa-search"></i> <?php echo $this->lang->line('core.btn_view'); ?> </a></li>
						<?php endif;
						if($access['is_edit'] ==1) : ?>
						<li><a  href="<?php echo site_url('groups/add/'.$row->group_id)?>"  class="tips "  title="edit"> <i class="fa fa-edit"></i>  <?php echo $this->lang->line('core.btn_edit'); ?> </a> </li>
						<?php endif;?>
...
$(document).ready(function(){
	...
	$('.do-quick-search').click(function(){
		$('#SximoTable').attr('action','<?php echo site_url("groups/multisearch");?>');
		$('#SximoTable').submit();
	});
